...
CONFIGURATION:
   -config string                flag config file (default "C:\\Users\\brett\\AppData\\Roaming\\subfinder\\config.yaml")
   -pc, -provider-config string  provider config file (default "C:\\Users\\brett\\AppData\\Roaming\\subfinder\\provider-config.yaml")
